      ...
      <div className="relative flex-1 rounded-2xl bg-white py-6 my-4 mx-4 overflow-hidden">
        ...
        <div className="flex justify-between md:items-end flex-col md:flex-row gap-2 ml-8 mr-12">
          ...
          <div className="flex gap-2 ml-auto">
            ...
            <div
              className="bg-primary px-3 py-2.5 rounded-lg flex gap-1 items-center text-white cursor-pointer whitespace-nowrap"
              onClick={() => router.push(`edit-cattle/${cattleName}`)}
            >
        ...
        {/*Two parts */}
        <div className="flex flex-col md:flex-row gap-8 mt-8 sm:mx-8 flex-1">
          ...
          <div className="xl:flex-1 sm:mx-0 mx-4">
          {cattleDetails?.cattleDetails?.cattleName && (
